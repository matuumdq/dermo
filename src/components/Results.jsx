		...
		<section id="resultados">
			<div className="grid mx-auto gap-6 lg:grid-cols-2">
				<div className="">
					...
					<img
						src="https://img.freepik.com/foto-gratis/vista-arriba-rejuvenecimiento-hermosa-mujer-disfrutando-procedimientos-cosmetologia-salon-belleza-dermatologia-manos-resplandores-azules-salud-terapia-botox_197531-2783.jpg?w=1380&t=st=1686084699~exp=1686085299~hmac=6063a3c0f0154abbc0aa189295d6abcc67f5ab5254c64458dc5fcb1176f76ff6"
						alt="resultados"
				...
				<div className="p-8 space-y-8 rounded-md lg:col-span-full lg:py-12 bg-moody-blue-800/70">
					...
					<p className="text-moody-blue-50">
						En mi consulta, te ofrezco una atención personalizada y
						centrada en tus necesidades individuales. Mi objetivo es
						brindarte una experiencia única y resultados
						excepcionales. Desde el momento en que entras por la
						puerta, te recibiré con calidez y dedicación. Trabajaré
						estrechamente contigo para comprender tus
						preocupaciones, metas y preferencias, para así crear un
						plan de tratamiento completamente adaptado a ti.
					</p>
				</div>
			</div>
		</section>
